...
**processImports方法中调用getImports获得所有@Import注解的value**
...
### 6.3执行ConfigurationClassParser#processDeferredImportSelectors方法对@Import注解进行处理（[详情查看SpringBoot自动配置源码剖析](../../Spring Boot/SpringBoot源码剖析)）

![image-20210706001920781](images/image-20210706001920781.png)

**执行DeferredImportSelectorGrouping#getImports通过ImportSelector解析spring.factories文件下所有需自动配置的全限定类名（[详情查看SpringBoot自动配置源码剖析](../../Spring Boot/SpringBoot源码剖析)）**
