...
public class MapperJacksonUtils {
    ...
    public static <T> List<T> json2listByTree(String result,String params, Class<T> clazz) throws Exception {
        JsonNode jsonNode = objectMapper.readTree(result);
        JsonNode data = jsonNode.findPath(params);
